...
function updateCart(cake) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post("update-cart", cake).then(function (res) {
    ...
    toastr__WEBPACK_IMPORTED_MODULE_1___default().success("Item added to cart");
    ...
    toastr__WEBPACK_IMPORTED_MODULE_1___default().error("Something went wrong");
    (toastr__WEBPACK_IMPORTED_MODULE_1___default().options) = {
      closeButton: true,
      progressBar: true,
      positionClass: "toast-top-right",
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcake_web_app"] = self["webpackChunkcake_web_app"] || [];
